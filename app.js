...
function set_ready() {
  ...
  document.getElementById("answer_area").innerHTML =
    "<form name='answer_form'><input type='text' name='player_answer' placeholder='回答を入力'>　<input class='player_answer' type='button' value='回答' onclick='answer_judge()'></form>";
  //問題シャッフル
...
function setNextText() {
  if (wordCount >= qa[gameNumber - 1][1].length - 1) {
    document.getElementById("next_area").innerHTML =
      "<input type='button' value='▷' id='set_next_btn' class='set_next_btn' onclick='setNextText()' disabled>";
  }
